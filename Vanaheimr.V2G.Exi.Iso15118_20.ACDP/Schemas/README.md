# ISO 15118-20 ACDP schemas — provenance

The normative ISO 15118-20 (2022) EXI schemas for the **ACDP** message set, used as
...
|---|---|
| `V2G_CI_ACDP.xsd` | `urn:iso:std:iso:15118:-20:ACDP` |

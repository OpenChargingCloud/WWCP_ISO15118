# ISO 15118-20 AC_DER_IEC schemas — provenance

The normative ISO 15118-20 (2022) EXI schemas for the **AC_DER_IEC** message set, used as
...
| `V2G_CI_AC_DER_IEC.xsd` | `urn:iso:std:iso:15118:-20:AC-DER-IEC` |

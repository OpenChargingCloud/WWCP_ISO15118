...
namespace cloud.charging.open.protocols.ISO15118_20
{
    ...
    /// <summary>
    /// Extention methods for session identifications.
    /// </summary>
    ...
    /// 
    /// xs:hexBinary, length: 8
    //  Could also be implemented as an array of 8 bytes!
    /// </summary>
                                        ...
                                        IComparable<Session_Id>
    {
        ...
        public static Session_Id NewRandom()
            ...
            => new (RandomExtensions.RandomHexString(16));
        ...
        /// <summary>
        /// Parse the given string as a session identification.
        /// </summary>

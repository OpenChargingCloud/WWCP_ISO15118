# ISO 15118-20 WPT schemas — provenance

The normative ISO 15118-20 (2022) EXI schemas for the **WPT** message set, used as
...
| `V2G_CI_WPT.xsd` | `urn:iso:std:iso:15118:-20:WPT` |
